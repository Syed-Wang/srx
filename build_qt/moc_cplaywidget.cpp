...
#include <memory>
#include "../../pro_ffmpeg_qt/cplaywidget.h"
...
QT_MOC_LITERAL(1, 12, 12), // "PlayOneFrame"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 11), // "getOneFrame"
QT_MOC_LITERAL(4, 38, 5), // "char*"
QT_MOC_LITERAL(5, 44, 4), // "data"
QT_MOC_LITERAL(6, 49, 3) // "len"

    },
    "CPlayWidget\0PlayOneFrame\0\0getOneFrame\0"
    "char*\0data\0len"
};
...
void CPlayWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->PlayOneFrame(); break;
        case 1: _t->getOneFrame((*reinterpret_cast< char*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
